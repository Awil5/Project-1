#310_win_loss_player_data:05:00:00 AM   -$82,348        Amirah Schneider,Nola Portillo, Mylie Schmidt,Suhayb Maguire,Millicent Betts,Avi Grav$
...
#0312_win_loss_player_data:08:00:00 PM   -$65,792        Tallulah Rawlings,Josie Dawe, Mylie Schmidt,Hakim Stott, Esther Callaghan, Ciaron Vil$
...
cat 0312_Dealer_schedule | awk -F " " '{print $1, $2, $5, $6}' | grep '5:00:00 AM' >> Dealers_working_during_losses 
cat 0312_Dealer_schedule | awk -F " " '{print $1, $2, $5, $6}' | grep '8:00:00 AM' >> Dealers_working_during_losses 
...
cat 0315_Dealer_schedule | awk -F " " '{print $1, $2, $5, $6}' | grep '5:00:00 AM' >> Dealers_working_during_losses 
cat 0315_Dealer_schedule | awk -F " " '{print $1, $2, $5, $6}' | grep '8:00:00 AM' >> Dealers_working_during_losses
